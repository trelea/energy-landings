...
export default function ServiceCard({ title, description, imageUrl, redirectLink }: ServiceCardProps) {
    return (
        <div className='flex flex-col gap-6 p-6 w-full bg-[#fffcf2] border border-[#fce8ac] rounded-xl'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <a href={redirectLink} className='text-[#FFC107] font-medium flex items-center gap-2'>
                    Mai mult
