...
export default function ServiceCard({ title, description, imageUrl, redirectLink }: ServiceCardProps) {
    return (
        <div className='flex flex-col gap-6 p-6 w-full bg-[#F5FAFF] border border-[#dfeeff] rounded-xl'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <a href={redirectLink} className='text-[#007BFF] font-medium flex items-center gap-2'>
                    Mai mult
