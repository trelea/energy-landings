...
export default function ServiceCard({ title, description, imageUrl, redirectLink }: ServiceCardProps) {
    return (
        <div className='flex flex-col gap-6 p-6 w-full bg-[#dafbff3d] border border-[#DAFBFF] rounded-xl'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <a href={redirectLink} className='text-[#00BCD4] font-medium flex items-center gap-2'>
                    Mai mult
