...
export default function ServicesLandingCard({ title, description, redirectLink }: ServiceLandingCardProps) {
    return (
        <a href={redirectLink} className='cursor-pointer flex flex-col gap-6 items-start justify-end p-6 bg-gradient-to-b from-[#f1f6fc] to-[#dbecfd] rounded-xl aspect-square sm:aspect-video lg:aspect-square w-full'>
