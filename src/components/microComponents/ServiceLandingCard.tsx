...
export default function ServicesLandingCard({ title, description, redirectLink }: ServiceLandingCardProps) {
    return (
        <a href={redirectLink} className='cursor-pointer flex flex-col gap-6 items-start justify-end p-6 bg-gradient-to-b from-[#FFFCF5] to-[#FFF4D4] rounded-xl aspect-square sm:aspect-video lg:aspect-square w-full'>
            <div className='flex items-center justify-center p-4 bg-gradient-to-b from-[#FFC107] to-[#CC9900] rounded-xl'>
