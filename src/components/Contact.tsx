...
export default function Contact() {
  ...
  return (
    <div className='bg-gradient-to-t from-[#FFE9E2] to-white w-full py-20'>
      <div id='contact' className="container xl:max-w-screen-xl w-full mx-auto px-4">
        <div className='flex gap-8 lg:gap-14 justify-between items-center flex-col lg:flex-row'>
          ...
          >
            ...
            <button
              type="submit"
              className='bg-[#FF5722] text-white ps-6 p-3 rounded-full w-full flex items-center justify-between gap-2 hover:bg-[#ff5622b7]'
            >
