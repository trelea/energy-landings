            ...
            <div className='flex flex-col gap-8 justify-center'>
                ...
                <div className='flex flex-col gap-14'>
                    <div className='flex flex-col lg:flex-row gap-10 lg:gap-14 items-start lg:items-center'>
                        <Image src={t('steps.0.image')} alt={'process step 0'} width={350} height={600} className='w-full'/>
                        <div className='flex flex-col gap-4'>
                            <span className='text-2xl font-medium'>{t('steps.0.title')}</span>
                            <span>{t('steps.0.description')}</span>
                            <a href="#" className='text-[#007BFF] font-medium flex items-center gap-2'>
                                {t('steps.0.button')}
                    ...
                    <div className='flex flex-col lg:flex-row gap-10 lg:gap-14 items-start lg:items-center'>
                        <Image src={t('steps.1.image')} alt={'process step 0'} width={350} height={600} className='w-full lg:order-1'/>
                        <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col lg:flex-row gap-10 lg:gap-14 items-start lg:items-center'>
                        <Image src={t('steps.2.image')} alt={'process step 0'} width={350} height={600} className='w-full'/>
                        <div className='flex flex-col gap-4'>
