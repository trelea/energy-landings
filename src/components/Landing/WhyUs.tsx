                ...
                <div className='flex flex-col xl:flex-row gap-14'>
                    <div className='flex flex-col gap-14'>
                        <div className='flex flex-col gap-8 items-start justify-center'>
                            <div className='w-16 h-16 flex justify-center items-center text-white text-center text-2xl p-3 bg-gradient-to-b from-[#FF5722] to-[#CC3000] rounded-full'>01</div>
                        ...
                        <div className='flex flex-col gap-8 items-start justify-center'>
                            <div className='w-16 h-16 flex justify-center items-center text-white text-center text-2xl p-3 bg-gradient-to-b from-[#FF5722] to-[#CC3000] rounded-full'>02</div>
                            <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-14'>
                        <div className='flex flex-col gap-8 items-start xl:items-end justify-center'>
                            <div className='w-16 h-16 flex justify-center items-center text-white text-center text-2xl p-3 bg-gradient-to-b from-[#FF5722] to-[#CC3000] rounded-full'>03</div>
                        ...
                        <div className='flex flex-col gap-8 items-start xl:items-end justify-center'>
                            <div className='w-16 h-16 flex justify-center items-center text-white text-center text-2xl p-3 bg-gradient-to-b from-[#FF5722] to-[#CC3000] rounded-full'>04</div>
                            <div className='flex flex-col justify-center items-start xl:items-end gap-4'>
