                ...
                <div className='flex flex-col xl:flex-row gap-14 items-center'>
                    <div className='flex flex-col gap-14'>
                        <div className='flex flex-col gap-8 items-start justify-center'>
                            <div className='flex flex-col gap-4 p-4 border rounded-xl border-[#E0E0E0] bg-[#F9FCFF] w-full'>
                    ...
                    <div className='flex flex-col gap-14'>
                        <div className='flex flex-col gap-8 items-start xl:items-end justify-center'>
                            <div className='flex flex-col justify-center items-start lg:items-end gap-4 p-4 rounded-xl border border-[#E0E0E0] bg-[#F9FCFF] w-full'>
                        ...
                        <div className='flex flex-col gap-8 items-start xl:items-end justify-center'>
                            <div className='flex flex-col justify-center gap-4 items-start lg:items-end p-4 border rounded-xl border-[#E0E0E0] bg-[#F9FCFF] w-full'>
