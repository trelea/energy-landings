      ...
      <div className="h-[60%]">
        <div className="container mx-auto px-5 flex flex-col h-full items-center justify-center gap-9">
          ...
          <div className="flex gap-4 items-center justify-center w-full max-w-md">
            <a
              href="#contact"
              className="bg-[#ffece8] ps-6 p-3.5 rounded-full w-full gap-8 flex items-center justify-between hover:bg-[#feeae6]"
            >
              <span></span>
              <span className="text-[#001D3D] font-medium">{t('cta')}</span>

              <Image src="/icons/arrow-up-filled.svg" width={42} height={34} alt="" />
            </a>
          </div>
        </div>
