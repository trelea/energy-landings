      ...
      <div className='h-1/2'>
        ...
        <div className="container mx-auto px-5 flex flex-col h-full items-center justify-center gap-9">
          <div className='flex flex-col gap-2 items-center justify-center max-w-xl lg:max-w-3xl'>
            <span className='text-center text-base lg:text-xl opacity-80 text-white'>{t('label')}</span>

            <span className='text-4xl md:text-6xl lg:text-[81px] text-center font-semibold text-white leading-snug'>{t('title1')}</span>
          </div>

          <div className='flex gap-4 items-center justify-center w-full max-w-xs'>

            <a href="#contact" className='bg-white ps-6 p-3 rounded-full w-full flex items-center justify-between gap-2 hover:bg-[#eeeeee]'>
